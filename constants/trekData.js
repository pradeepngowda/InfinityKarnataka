export const TREK_DETAILS = {
  ...
  "Bandaje": {
    title: "Bandaje Arbi & Rani Jhari Trek",
    ...
    itinerary: [
      ...
      },
      {
        ...
        activities: [
          ...
          "Freshen up and have a hearty breakfast.",
          "Begin the Bandaje Arbi main trek towards the falls.",
          "Complementary visit to the breathtaking Rani Jhari viewpoint.",
          "Packed lunch amidst the shola forests.",
          "Return to homestay for campfire, group bonding, and dinner."
        ]
      },
      {
        day: "Day 2: Tea Estates & Heritage",
        activities: [
          "Breakfast at the homestay.",
          "Explore the lush Kalaguru Tea Estate.",
          "Experience the serene atmosphere and take pictures in the greenery.",
          "Post lunch (self-sponsored), start the journey back to Bangalore."
        ]
      }
    ],
    inclusions: [
    ...
    carryList: [
      "Trekking shoes with good grip",
      "Light backpack (No trolley bags)",
      "Reusable water bottle (Mandatory)",
      "Personal medications & Odomos",
      "Rain coat & Umbrella (High rainfall zone)",
      "Torch light & Powerbank",
      "Copy of Aadhar card"
    ],
    terms: [
      "Initial booking is non-refundable.",
      "Strictly no alcohol/smoking during the trek.",
      "Sharing basis stay in dormitories.",
      "Cooperate with coordinators for seat adjustments.",
      "Follow zero-waste policy in forest areas."
    ]
  },
  "Gangadikal": {
    title: "Gangadikal Peak Trek",
    subtitle: "Kudremukh Range Exploration",
    duration: "2 Days / 1 Night",
    pickupPoints: [
      "MAJESTIC Shanthala Silks, Bangalore (7:00 PM)",
    ...
    itinerary: [
      ...
      },
      {
        ...
        activities: [
          "Early morning arrival at Samse/Kudremukh homestay.",
          "Freshen up and have a traditional Malnad breakfast.",
          "Begin the Gangadikal main trek through lush shola forests and grasslands.",
          "Packed lunch with a view of the rolling hills.",
          "Return to homestay for an evening of campfire, bonding, and dinner."
        ]
      },
  ...
  "Narasimha Parvatha": {
    ...
    itinerary: [
      ...
      },
      {
        ...
        activities: [
          "Arrival at Agumbe/Sringeri homestay.",
          "Breakfast and briefing by the trek lead.",
          "Trek to Narasimha Parvatha Peak - the highest point in Agumbe.",
          "Experience the dense rainforest and breathtaking views.",
          "Packed lunch at the peak (Carry your lunch box).",
          "Evening campfire at homestay with shared stories and dinner."
        ]
      },
      {
        day: "Day 2: Sacred Falls & Temples",
        activities: [
          "Breakfast at homestay.",
          "Visit Koodlu Theertha Falls - a magnificent single-tier waterfall.",
          "Explore Varanga Jain Temple - a 12th-century masterpiece in the middle of a lake.",
          "Visit Sringeri Sharadamba Temple on the banks of Tunga River.",
          "Lunch (Self-sponsored) and depart for Bangalore."
        ]
      }
    ],
    inclusions: [
    ...
    exclusions: [
      ...
      "Expenses due to landslides or weather disruptions",
      "Anything not mentioned in inclusions"
    ],
    carryList: [
      "Sturdy trekking shoes",
      "Comfortable backpack",
      "Rain coat & Umbrella (Agumbe is the Cherrapunji of South)",
      "Odomos spray (Vital for Agumbe leeches)",
      "Reusable water bottle (Mandatory)",
      "Xerox copy of ID proof",
      "Personal medications"
    ],
    terms: [
      "Basic level of fitness is compulsory for this trek.",
      "Strictly follow reporting times and instructions.",
      "Zero tolerance towards illegal substances.",
      "Sharing basis stay - separate for male and female.",
